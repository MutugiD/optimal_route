"""
Django settings for optimal_api project.
...
MIDDLEWARE = [
    ...
    'route_optimizer.middleware.SecurityMiddleware',
]

ROOT_URLCONF = 'optimal_api.urls'
...
WSGI_APPLICATION = 'optimal_api.wsgi.application'
